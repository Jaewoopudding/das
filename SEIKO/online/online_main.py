...
from online.model_utils import jpeg_compressibility, online_jpeg_loss_fn, generate_embeds_fn, evaluate_loss_fn, evaluate, prepare_pipeline, generate_new_x, online_aesthetic_loss_fn
...
def main(_):
    ...
    for outer_loop in range(config.train.num_outer_loop):        
        ...
        if config.reward_fn == "aesthetic":
            ...
            print(all_new_ims.shape)
            print(all_new_y.shape)
